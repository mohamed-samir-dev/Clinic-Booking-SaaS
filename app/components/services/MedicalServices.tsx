    ...
    <section className={`py-12 sm:py-16 md:py-20 ${theme === 'dark' ? 'bg-gray-900' : 'bg-linear-to-b from-gray-50 to-white'}`}>
      <div className="w-full px-4 md:px-8">
        <div className="mb-8 sm:mb-10 md:mb-14 text-center">
          ...
          <p className={`text-sm sm:text-base md:text-lg max-w-2xl mx-auto px-4 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>Comprehensive healthcare services from trusted clinics near you.</p>
        </div>
        <Swiper
