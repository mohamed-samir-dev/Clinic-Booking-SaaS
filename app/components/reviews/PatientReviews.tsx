    ...
    <section className="py-20 bg-gray-50">
      <div className="w-full px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-lg p-8 border border-gray-100 h-[400px] flex flex-col">
          ...
          <div className="bg-white rounded-3xl shadow-lg p-6 border border-gray-100 h-[400px] flex flex-col">
            <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar space-y-4">
              {reviews.map((review) => (
                <div
                  key={review._id}
                  className="rounded-2xl p-6 border border-gray-100 hover:shadow-md transition-shadow bg-gray-50"
                >
                  <div className="flex items-start gap-4">
                    <div className="shrink-0">
                      <div className="w-12 h-12 rounded-full bg-linear-to-br from-teal-400 to-teal-600 flex items-center justify-center text-white font-bold text-lg shadow-md">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="relative">
                        <FaQuoteLeft className="absolute -left-1 -top-1 text-teal-200 text-xl" />
