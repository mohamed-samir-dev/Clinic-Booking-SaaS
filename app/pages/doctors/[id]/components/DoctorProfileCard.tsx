      ...
      <div className="relative bg-linear-to-br from-teal-500 via-teal-600 to-cyan-600 px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8 lg:pt-10 pb-16 sm:pb-20 lg:pb-24">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 lg:gap-8">
            ...
            {/* Doctor Info */}
            <div className="flex-1 text-center sm:text-left space-y-2 sm:space-y-3 lg:space-y-4 w-full">
              <div className="inline-flex items-center gap-2 bg-white/25 backdrop-blur-md px-4 lg:px-5 py-2 lg:py-2.5 rounded-xl lg:rounded-2xl shadow-lg border border-white/30">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-2">
                {clinicName && clinicId && (
                  <Link href={`/pages/clinics/${clinicId}`} className="flex items-center justify-center gap-2 bg-white/20 backdrop-blur-sm px-4 lg:px-5 py-2.5 lg:py-3 rounded-xl border border-white/30 shadow-lg hover:bg-white/30 transition-all group">
                    <div className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                    <span className="text-white font-semibold text-sm lg:text-base">Clinic: {clinicName}</span>
                    <FaArrowRight className="text-white text-sm group-hover:translate-x-1 transition-transform" />
                  </Link>
                )}
                <button 
                  onClick={handleQuickBook}
                  className="inline-flex items-center justify-center gap-2 bg-white text-teal-600 px-6 lg:px-8 py-2.5 lg:py-3.5 rounded-xl font-bold text-sm lg:text-lg shadow-xl hover:shadow-2xl transition-all hover:scale-105"
                >
