  ...
  return (
    <div className={`rounded-xl shadow-lg p-4 sm:p-6 md:p-8 border-2 ${theme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-teal-100'}`}>
      <div className="flex items-center gap-3 mb-4 sm:mb-6">
        ...
        <h3 className={`text-xl sm:text-2xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>Send us a Message</h3>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
        ...
        <div>
          <label className={`block text-sm sm:text-base font-bold mb-2 ${theme === 'dark' ? 'text-gray-200' : 'text-gray-800'}`}>Full Name</label>
          <input
            type="text"
            name="fullName"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
          <div>
            <label className={`block text-sm sm:text-base font-bold mb-2 ${theme === 'dark' ? 'text-gray-200' : 'text-gray-800'}`}>Email Address</label>
            <input
              type="email"
              name="email"
          ...
          <div>
            <label className={`block text-sm sm:text-base font-bold mb-2 ${theme === 'dark' ? 'text-gray-200' : 'text-gray-800'}`}>Phone Number</label>
            <input
              type="tel"
              name="phone"
        ...
        <div>
          <label className={`block text-sm sm:text-base font-bold mb-2 ${theme === 'dark' ? 'text-gray-200' : 'text-gray-800'}`}>Subject</label>
          <select
            name="subject"
        ...
        <div>
          <label className={`block text-sm sm:text-base font-bold mb-2 ${theme === 'dark' ? 'text-gray-200' : 'text-gray-800'}`}>Your Message</label>
          <textarea
            name="message"
