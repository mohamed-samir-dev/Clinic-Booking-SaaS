...
export default function ContactInfo() {
  ...
  const t = translations[locale].contact.info;
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className={`rounded-xl shadow-lg p-4 sm:p-6 border-2 ${theme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-teal-100'}`}>
        <div className="flex items-center gap-3 mb-3 sm:mb-4">
          ...
          <h3 className={`text-lg sm:text-xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>{t.location}</h3>
        </div>
        <p className={`text-sm sm:text-base mb-3 sm:mb-4 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>{t.locationAddress}</p>
        <a
      ...
      <div className={`rounded-xl shadow-lg p-4 sm:p-6 border-2 ${theme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-teal-100'}`}>
        <div className="flex items-center gap-3 mb-3 sm:mb-4">
          ...
          <h3 className={`text-lg sm:text-xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>{t.phone}</h3>
        </div>
        <p className={`font-semibold text-base sm:text-lg mb-2 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>+20 1012486445</p>
        <p className={`text-xs sm:text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>{t.phoneAvailability}</p>
      </div>
      ...
      <div className={`rounded-xl shadow-lg p-4 sm:p-6 border-2 ${theme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-teal-100'}`}>
        <div className="flex items-center gap-3 mb-3 sm:mb-4">
          ...
          <h3 className={`text-lg sm:text-xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>{t.email}</h3>
        </div>
      ...
      <div className="bg-linear-to-r from-teal-500 to-teal-600 rounded-xl shadow-lg p-4 sm:p-6 text-white">
        <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3">{t.whatsappTitle}</h3>
        <p className="text-sm sm:text-base text-teal-50 mb-3 sm:mb-4">{t.whatsappDescription}</p>
        <a
