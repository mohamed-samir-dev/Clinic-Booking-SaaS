    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 border-2 border-teal-100">
        <div className="flex items-center gap-3 mb-3 sm:mb-4">
          ...
          <h3 className="text-lg sm:text-xl font-bold text-gray-900">Phone Number</h3>
        </div>
        <p className="text-gray-900 font-semibold text-base sm:text-lg mb-2">+20 1012486445</p>
        <p className="text-gray-600 text-xs sm:text-sm">Available Sun-Thu, 9am - 9pm</p>
      </div>
