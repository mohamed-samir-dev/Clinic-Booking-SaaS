import { PasswordFieldProps } from '../types/register';
import { useTheme } from '@/app/contexts/ThemeContext';


export const PasswordField = ({ label, name, placeholder, register, error, showPassword, onToggle }: PasswordFieldProps) => {
