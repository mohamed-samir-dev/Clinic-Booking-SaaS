...
export default function ServiceHero({ service, duration, price }: ServiceHeroProps) {
  ...
  return (
    <div className="relative bg-[#D5F5F0] py-12 sm:py-16 md:py-20 px-4 md:px-8 overflow-hidden">
      ...
      <div className="w-full relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-gray-900 mb-4 sm:mb-6 px-2">
            {service.title === 'Dentistry' ? 'Dental Cleaning & Checkup' : `${service.title} Consultation`}
          </h2>

          <p className="text-base sm:text-lg md:text-xl text-gray-800 mb-6 sm:mb-10 leading-relaxed max-w-2xl mx-auto px-2">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 mb-6 sm:mb-10">
            <div className="flex items-center gap-2 sm:gap-3 bg-white/80 backdrop-blur-sm px-4 sm:px-6 py-2 sm:py-3 rounded-full shadow-md">
              <FaClock className="text-teal-600 text-xl sm:text-2xl" />
              <span className="text-gray-900 font-semibold text-base sm:text-lg">{duration}</span>
            </div>
            <div className="flex items-center gap-2 sm:gap-3 bg-white/80 backdrop-blur-sm px-4 sm:px-6 py-2 sm:py-3 rounded-full shadow-md">
              <FaDollarSign className="text-teal-600 text-xl sm:text-2xl" />
              <span className="text-gray-900 font-semibold text-base sm:text-lg">{price}</span>
            </div>
          </div>
